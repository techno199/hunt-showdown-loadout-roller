  ...
  return (
    <button
      className={clsx(className, 'relative duration-200', {
        // Stroke
        ['font-gt-sectra-fine tracking-[.6em] text-[1.6em] uppercase z-10 text-white duration-200 after:content-[""] after:absolute after:left-1/2 after:top-1/2 after:-z-10 ' +
